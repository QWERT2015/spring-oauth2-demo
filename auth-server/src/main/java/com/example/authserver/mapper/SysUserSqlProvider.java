...
import com.example.authserver.model.SysUserExample.Criteria;
import com.example.authserver.model.SysUserExample.Criterion;
...
public class SysUserSqlProvider {
     ...
     * @mbg.generated Thu Aug 31 10:44:16 CST 2023
     */
    public String insertSelective(SysUser row) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysUser row = (SysUser) parameter.get("row");
        ...
        if (row.getCreateUser() != null) {
            sql.SET("create_user = #{row.createUser,jdbcType=BIGINT}");
        }
        
        if (row.getUpdateTime() != null) {
            sql.SET("update_time = #{row.updateTime,jdbcType=TIMESTAMP}");
        }
        
        if (row.getUpdateUser() != null) {
            sql.SET("update_user = #{row.updateUser,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated Thu Aug 31 10:44:16 CST 2023
     */
    public String updateByPrimaryKeySelective(SysUser row) {
        SQL sql = new SQL();
        sql.UPDATE("sys_user");
